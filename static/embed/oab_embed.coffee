...
_oab = (opts) ->
  try
    ...
    this.uid ?= 'anonymous'
    this.api ?= if window.location.host.indexOf('dev.openaccessbutton.org') isnt -1 then 'https://dev.api.cottagelabs.com/service/oab' else 'https://bg.api.oa.works'
...
<div class="_oab_panel" id="_oab_inputs">
  ...
  <p><input class="_oab_form" type="text" id="_oab_input" placeholder="e.g. 10.1016/j.cplett.2012.10.045" aria-label="Enter a search term" style="box-shadow:none;"></input></p>
